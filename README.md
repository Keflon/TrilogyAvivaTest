...
-	It’s barely tested, very hot off the press. I’m confident it’s robust.
...
- IoC achieved using SimpleInjector. See *Startup.cs*
...
ValueConverters (it can do much more). I wrote that too.
...
## Extras:
If you mis-spell a location and the API finds a suitable location, the spelling is corrected, and if the (mis-spelt) location has been saved, the saved location is updated.
The app counts how many times it has been cold-started and says ‘Hi’ on first run.
-	You can reset this count on the HomePage.
Buttons disable or hide themselves as appropriate.
-	Using CommandZeroAsync. I wrote that too. NuGet Gallery | FunctionZero.CommandZero 1.1.0
